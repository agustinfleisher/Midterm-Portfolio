...
ggplot(data = surveys,
  ...
  labs(
    ...
    subtitle = "Boxplots colored by sex (viridis palette)",
    x = "Species",
    y = "Weight (grams)"
  ) +
  theme_bw() +
...
ggplot(data = surveys,
  ...
  scale_fill_manual(
    values = c("F" = "#ff7a90", "M" = "#65d6ff", "NI" = "#94a3b8", "unknown" = "#cbd5e1")
  ) +
  labs(
    title = "Rodent Weights by Species",
    subtitle = "Pastel palette + minimal grid keeps focus on the distributions",
    x = "Species",
    y = "Weight (grams)"
  ) +
  theme_minimal(base_size = 13) +
  theme(
    plot.background = element_rect(fill = "#0b1221", color = NA),
...
ggplot(data = surveys,
  ...
  labs(
    ...
    subtitle = "Legend pulled into the title; axis labels stand alone",
    x = "Species",
    y = "Weight (grams)"
  ) +
